...
#include <windows.h> // CreateProcess(...), ZeroMemory(...), ...
//==============================================================================
void spawnProcess(char* progName)
{
  ...
  */
  ...
  // Start the new process.
    ...
    {
      printf("Program Started: %s", progName);
    }
}
//==============================================================================
...
int main()
{
	...
	for(int progIndex = 0; 	progIndex < NUM_BINARIES; ++progIndex)
	{
		...
		char progName[20];
	  strcpy(progName, tmpnam(NULL)); //tempnam(dir, prefix);

	  // Append .exe to the end of the file name bc Windoz
	  strcat(progName, ".exe");

	  // remove first character.
	  memmove(progName, progName+1, strlen(progName));
